...
OR::OR(){
  ...
  */
  ...
  NAND_1.INPUT_BUFFER_B.A.connect(INPUT_BUFFER_A.B);

  NAND_2.INPUT_BUFFER_A.A.connect(INPUT_BUFFER_B.B);
  NAND_2.INPUT_BUFFER_B.A.connect(INPUT_BUFFER_B.B);

  NAND_3.INPUT_BUFFER_A.A.connect(NAND_1.OUTPUT_BUFFER_C.B);
  NAND_3.INPUT_BUFFER_B.A.connect(NAND_2.OUTPUT_BUFFER_C.B);


  OUTPUT_BUFFER_C.A.connect(NAND_3.OUTPUT_BUFFER_C.B);

}

//update function

void OR::update_output(std::queue<COMPONENT*> &external_update_queue){
